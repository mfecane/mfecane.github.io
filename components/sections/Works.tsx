import type { WorkItem } from "./WorksItem"
import SmallWorksItem from "./SmallWorksItem"
...
export default function Works() {
	const works: WorkItem[] = [
		...
		},
		{
			...
			link: "https://shadowcrypt-eight.vercel.app/",
	...
	const big = works.filter((w) => w.size === "big")
	const small = works.filter((w) => w.size === "small")

	return (
		<section className="bg-ink-deep py-20 text-paper" id="works">
